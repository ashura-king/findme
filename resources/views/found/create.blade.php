...
@section('title', 'Report Found Item — Lost & Found')
...
<style>
  ...
  /* Rest of the form styles from lost item create form */
  .form-group {
    margin-bottom: 2rem;
    position: relative;
  }
  ...
  <div class="report-form-container">
    <div class="form-card">
      <div class="form-header">
        ...
        <h1 class="form-title">Report Found Item</h1>
        <p class="form-subtitle">Help reunite lost items with their owners</p>
      </div>

      <form action="{{ route('found.store') }}" method="POST" enctype="multipart/form-data" id="foundItemForm">
        @csrf
        ...
        <div class="form-group">
          ...
          <span class="form-hint">The more details you provide, the better chance of finding the owner</span>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="location_found" name="location_found" class="form-input"
              placeholder="e.g., Central Park, Coffee Shop, Bus Station" required value="{{ old('location_found') }}">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="date" id="date_found" name="date_found" class="form-input" required
              value="{{ old('date_found') }}" max="{{ now()->format('Y-m-d') }}">
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="finder_name" name="finder_name" class="form-input" placeholder="Enter your full name"
              required value="{{ old('finder_name') }}">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" id="finder_contact" name="finder_contact" class="form-input"
              placeholder="Phone number or email" required value="{{ old('finder_contact') }}">
            <span class="form-hint">So the owner can contact you to claim the item</span>
          </div>
        </div>
        ...
        <div class="form-actions">
          <a href="{{ route('found.index') }}" class="btn-cancel">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Log form data on change for debugging
